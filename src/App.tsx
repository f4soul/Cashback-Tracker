...
export default function App() {
  ...
  const currentMonthData = allData.find(
    (d) => d.monthId === currentMonthId,
  ) || { monthId: currentMonthId, entries: [] };
  const archiveData = allData
      ...
      >
        <div className="px-6 py-4 flex flex-col md:gap-8">
          <div className="flex items-center justify-between w-full">
            ...
            <button
              onClick={toggleTheme}
              className="p-2.5 rounded-2xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all hover:scale-105 active:scale-95 cursor-pointer"
              title={
                theme === 'light'
            ...
            <button
              ...
              className={clsx(
                ...
                activeTab === 'current'
                  ...
                  : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white cursor-pointer',
              )}
            >
