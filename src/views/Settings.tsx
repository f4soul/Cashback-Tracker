...
export const Settings: React.FC<SettingsProps> = ({
  ...
  const handleCustomColorChange = (hex: string) => {
    if (/^#[0-9A-Fa-f]{6}$/i.test(hex) || /^#[0-9A-Fa-f]{3}$/i.test(hex)) {
      const bg = hex + '15'; // полупрозрачный фон
      setSettings((prev) => ({
        ...prev,
        accentColor: hex,
        percentBlockBg: bg,
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            {(['circle', 'square', 'rectangle'] as LogoShape[]).map((shape) => (
              <button
                ...
                className={clsx(
                  'flex items-center justify-center p-2 rounded-2xl border transition-all hover:scale-105 active:scale-95 cursor-pointer',
              ...
              >
                <div
                  className={clsx(
                    ...
                    shape === 'rectangle' &&
                      'w-3 h-4 sm:w-4 sm:h-7 rounded-[15%]',
                  )}
                />
              </button>
            ))}
              ...
              <div className="flex items-center justify-between gap-1 sm:gap-2 flex-1">
                {colors.map((color) => (
                  <button
                    ...
                    className={clsx(
                      'w-6 h-6 sm:w-7 sm:h-7 md:w-9 md:h-9 rounded-md border-2 transition-all flex items-center justify-center shrink-0 cursor-pointer',
                  ...
                  >
                    {settings.accentColor === color.value && (
                      <Check className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white mix-blend-difference" />
                    )}
                  </button>
                ))}
              </div>
                ...
                <div className="flex items-center gap-2">
                  {settings.fontSize !== 15 && (
                    <button
                      ...
                      className="flex items-center gap-1 cursor-pointer text-gray-500 hover:text-[var(--accent-color)] transition-colors font-bold uppercase tracking-wider text-[8px] sm:text-[10px]"
                  ...
                  <span className="text-[var(--accent-color)] text-[10px] sm:text-xs">
          ...
          <div className="p-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800 space-y-2 shadow-sm">
            <div className="grid grid-cols-3 gap-2 sm:gap-4">
              <button
                ...
                className="flex flex-col items-center cursor-pointer gap-1.5 sm:gap-2 p-2 sm:p-3 rounded-xl border border-blue-100 dark:border-blue-900/30 bg-blue-50/30 dark:bg-blue-900/10 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all group"
              >
                ...
                <span className="font-bold text-[8px] sm:text-[10px] text-blue-700 dark:text-blue-400 uppercase">
                  Image
                </span>
              </button>
              ...
              <button
                ...
                className="flex flex-col items-center cursor-pointer gap-1.5 sm:gap-2 p-2 sm:p-3 rounded-xl border border-emerald-100 dark:border-emerald-900/30 bg-emerald-50/30 dark:bg-emerald-900/10 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all group"
              >
                ...
                <span className="font-bold text-[8px] sm:text-[10px] text-emerald-700 dark:text-emerald-400 uppercase">
                  Excel
                </span>
              </button>
              ...
              <button
                ...
                className="flex flex-col items-center cursor-pointer gap-1.5 sm:gap-2 p-2 sm:p-3 rounded-xl border border-red-100 dark:border-red-900/30 bg-red-50/30 dark:bg-red-900/10 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all group"
              >
                ...
                <span className="font-bold text-[8px] sm:text-[10px] text-red-700 dark:text-red-400 uppercase">
                  PDF
                </span>
              </button>
            </div>
