    ...
    <div className="flex flex-col gap-6 pb-24">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">
          История кэшбека за прошлые месяцы
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4 flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={clsx(
              'p-2.5 rounded-xl border transition-colors flex items-center justify-center cursor-pointer',
            ...
            <div className="flex flex-col gap-1.5 relative">
              ...
              >
                <span
                  className={clsx(
                    'truncate',
                    !selectedCategoryFilter && 'text-gray-400',
                  )}
                >
        ...
        <div className="flex flex-col gap-4">
          {filteredData.map((month) => {
            ...
            return (
              <div
                key={month.monthId}
                className="bg-white dark:bg-gray-800/50 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden"
              >
                <button
                  onClick={() => toggleMonth(month.monthId)}
                  className="w-full flex items-center justify-between p-6 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                >
                    ...
                    >
                      <div className="p-6 pt-0 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/20">
                        ...
                        <div className="flex flex-col gap-3 mb-6 mt-6">
                          <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1 px-1">
                            Банки в этом месяце
                          </h4>
                                ...
                                >
                                  <div className="flex items-center gap-3 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                      <h3 className="font-bold text-xs text-gray-900 dark:text-white truncate uppercase tracking-tight">
                                        {bank.name}
                                      </h3>
                                    </div>
                                  </div>
                                  <button
                                    onClick={() =>
                                      handleDeleteEntry(month.monthId, entry.id)
                                    }
                                    className="p-2 cursor-pointer text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-xl transition-all"
                                  >
                        ...
                        <div className="flex justify-end gap-2 mb-4">
                          <button
                            ...
                            className="flex items-center gap-2 cursor-pointer text-[10px] font-bold text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 px-4 py-2.5 rounded-xl border border-emerald-100 dark:border-emerald-800/50 transition-all uppercase tracking-wider"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center cursor-pointer gap-2 text-[10px] font-bold text-red-600 dark:text-red-400 hover:bg-rАed-50 dark:hover:bg-red-900/20 px-4 py-2.5 rounded-xl border border-red-100 dark:border-red-800/50 transition-all uppercase tracking-wider"
                          >
